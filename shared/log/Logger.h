#ifndef _RISKEMULIBRARY_LOG_LOGGER_H_
#define _RISKEMULIBRARY_LOG_LOGGER_H_
...
private:
	...
	void printString(const char* typeStr, const char* fmt, va_list argptr);
	void printString(LogFile_ptr file, const char* typeStr, const char* fmt, va_list argptr, char *time = NULL);
